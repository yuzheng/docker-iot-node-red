...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("CHT_MQTT_Broker",MQTTBrokerNode,{
        credentials: {
            user: {type:"text"},
    ...
    function MQTTInNode(n) {
        ...
        this.product_code = n.product_code;
        this.serial_id = n.serial_id;
        this.topic = "";
        switch(this.dataType){
            case "rawdata":
                this.topic = "/v1/device/" + this.device_id + "/sensor/" + this.sensor_id + "/rawdata";
                break;
            case "csv":
                this.topic = "/v1/device/" + this.device_id + "/sensor/" + this.sensor_id + "/csv";
                break;
            case "command":
                this.topic = "/v1/device/" + this.device_id + "/sensor/" + this.sensor_id + "/command";
                break;
            case "ack":
                this.topic = "/v1/device/" + this.device_id + "/sensor/" + this.sensor_id + "/ack";
                break;
            case "heartbeat":
                this.topic = "/v1/device/" + this.device_id + "/heartbeat";
                break;
            case "SubscribeConfiguration":
                this.topic = "/v1/registry/" + this.product_code + this.serial_id;
                break;
        }
    ...
    RED.nodes.registerType("MqttSubscribe",MQTTInNode);
    ...
    function MQTTOutNode(n) {
        ...
        switch(this.dataType){
            case "rawdata":
                this.topic = "/v1/device/" + this.device_id + "/rawdata";
                break;
            case "command":
                this.topic = "/v1/device/" + this.device_id + "/command";
                break;
            case "ack":
                this.topic = "/v1/device/" + this.device_id  + "/ack";
                break;
            case "heartbeat":
                this.topic = "/v1/device/" + this.device_id + "/heartbeat";
                break;
        ...
        this.brokerConn = RED.nodes.getNode(this.broker);
        this.time = n.time;
        this.save_to_database = n.save_to_database;
        this.lat = n.lat;
        this.lon = n.lon;
        this.pulse = n.pulse;
        var node = this;
                        ...
                        msg.payload = [
                                          {
                                              ...
                                              "save": this.save_to_database
                                          }
                                      ];
                        if(this.time != ""){
                            msg.payload[0]["time"] = this.time;
                        }
                        if( ( this.lat != "" ) && ( this.lon != "") ){
                            msg.payload[0]["lat"] = this.lat;
                            msg.payload[0]["lon"] = this.lon;
                        }
                        break;
                    case "command":
                        msg.payload = [  
    ...
    RED.nodes.registerType("MqttPublish",MQTTOutNode);
};
